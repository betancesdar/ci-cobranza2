    ...
    <?php echo form_open('admin/loans/edit', 'id="loan_form"'); ?>
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-8">
          <label class="small mb-1" for="exampleFormControlSelect2">Buscar cliente por Identificacion</label>
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-4">
          <label class="small mb-1" for="inputUsername">Cedula</label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-12 col-md-4">
          <label class="small mb-1" for="exampleFormControlSelect2">Dia de pago</label>
