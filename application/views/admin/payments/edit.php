    ...
    <?php echo form_open('admin/payments/ticket'); ?>
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-8">
          <label class="small mb-1" for="exampleFormControlSelect2">Buscar cliente por Cedula</label>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-12 col-md-4 text-center">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <button class="btn btn-danger btn-block" id="interest_only" type="submit" disabled>Pagar Interes</button>
            </div>
            <br>
            <div class="col-6">
            ...
            <br>
            <div class="col-6">
              <button class="btn btn-info btn-block" id="retake" type="submit" disabled>Renganchar</button>
            </div>
          </div>
        </div>
      </div>
