<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    <div class="form-row">
      <div class="form-group col-md-4">
        <label class="small mb-1" for="inputUsername">Ingresar Lugar de trabajo</label>
      ...
      <div class="form-group col-md-4">
        <label class="small mb-1" for="inputUsername">Ingresar Nombre de Jefe Inmediato</label>
      ...
      <div class="form-group col-md-4">
        <label class="small mb-1" for="inputUsername">Ingresar Dirrecion de la empresa</label>
      ...
      <div class="form-group col-md-4">
        <label class="small mb-1" for="inputUsername">Ingresar Telefono de la empresa</label>
        <input class="form-control" id="inputUsername" type="text" name="company" value="<?php echo set_value('companyPhone', $this->input->post('company') ? $this->input->post('company') : $customer->company); ?>">
      </div>
      <br>
      <hr>
      <div class="card-header py-3"><?php echo empty($customer->first_name) ? 'Dato Garante' : 'Editar Cliente'; ?></div>
  <div class="card-body">
    <?php if(validation_errors()) { ?>
      <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <?php echo validation_errors('<li>', '</li>'); ?>
