<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">J&Y Group</div>
  </a>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url('admin/reclosing'); ?>">
      <i class="fas fa-fw fa-money-bill"></i>
      <span>Renganches</span></a>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapseReportes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="<?php echo site_url('admin/reports/days'); ?>">General x dia de pago</a>
