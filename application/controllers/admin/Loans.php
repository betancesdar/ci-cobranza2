...
class Loans extends CI_Controller {
  ...
  public function edit()
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $loan_data = $this->loans_m->array_from_post(['customer_id','credit_amount', 'interest_amount', 'num_fee', 'fee_amount', 'payment_m', 'coin_id','day', 'date']);
  ...
  {
    $data['loan'] = $this->loans_m->get_loancont($id);
    $data['items'] = $this->loans_m->get_loanItems($id);

    $this->load->view('admin/loans/contract', $data);
